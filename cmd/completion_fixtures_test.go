			...
			checks: []completionCheck{
				{
					desc:    "up lists all services",
					args:    []string{"up", ""},
					include: []string{"admin", "api", "aService", "anotherService", "web", "postgres"},
				},
				{
					desc:    "up filters already-used service",
					args:    []string{"up", "api", ""},
					include: []string{"admin", "aService", "anotherService", "web", "postgres"},
					exclude: []string{"api"},
				},
				{
					desc:    "shell lists all services",
				...
				},
				{
					...
					exclude: []string{"admin", "api", "aService", "anotherService", "web"},
				},
				{
					desc:    "run lists all nodejs services",
					args:    []string{"run", ""},
					include: []string{"admin", "api", "aService", "anotherService", "web"},
